 ...
 * Return: character pointer to newly created string. NULL if mallocfails.
 */
char *get_int(int num)
{
	unsigned int temp;
 ...
 * Return: unsigned integer rep of i
 */
 ...
 * @base: base of number respresentation used by buffer.
 * Return: Integer containg length of buffer needed(doesnt contain null).
 */
int get_numbase_len(unsigned int num, unsigned int base)
{
	int len = 1;
...
/**
 * fill_numbase_buff -fills buffer with corrent numbers up to base 36
